...
public class PolymorphismService {
	 ...
	 * - 상속 관계도 파악이 가능 (자식 객체 내부의 부모 객체도 인식) 
	 */
	...
	public void printObject(Object obj) {
		...
		if(obj instanceof Child) {
			...
			Child c = (Child)obj; // Chlid 다운 케스팅
			result = "[Child Type]\n";
...
//		else if(obj instanceof Object) {
	...
	/* [반환형의 다형성]
	 * - 메서드의 반환형을 부모 타입으로 설정하여 return되는 자깃 객체의 주소를 참조할 수 있게 함
   * - 다형성의 업캐스팅 적용
	 */
	 ...
	 * [동적 바인딩]
	 * - 프로그램 실행 중(Runtime) 
	 * 정적바인딩 된 메서드를 실제 객체 타입을 기준으로 연결
	 * 
	 * - 왜 사용?
	 * 1) 다운 캐스팅의 번거로움을 없앰
	...
	/* [객체 배열의 다형성]
	 * - 부모 타입의 참조변수를 묶음으로 다루어서 배열 각 요소에 업캐스팅 적용
	 * 
	 * * 객체 배열 : 객체 참조 변수의 묶음
	 */
	...
	public void test4(){
		 ...
		 * - 코드 수행 중 지정된 지점(breakpoint)에서 실행을 멈추고 해당 시점에 존재하는
		 *   변수/필드 값을 확인하는 모드
		 */
	...
	public void test6(Object obj) {
		 ...
		 * - 참조변수의 강제 형변환(다운캐스팅) 시 참조하는 객체가 변환하려는
		 * 타입이 아니거나 상속 관계도 아니면 형변환 불가 (ClassCastException) 발생
		 * */
