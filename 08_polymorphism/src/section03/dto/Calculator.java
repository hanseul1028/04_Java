 ...
 * 
 * [참고]
 * 대부분의 인터페이스를 상속 받은 클래스는 인터페이스에서 제공하는
 * 메서드만 오버라이딩 하고 별도의 필드 메서드를 작성하지 않는다
 * (약속, 규약)
 * -> 왜? 언제든지 동일한 코드로 실행될 수 있게 하기위해
 * 
 * - 인터페이스 작성법 ( [] : 생략가능 )
 * 1) 상수형 필드만 작성 가능
...
public interface Calculator {
	...
	// public static final 생략 가능 (컴파일러가 자동 추가)
