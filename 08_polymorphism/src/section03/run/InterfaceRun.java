...
import section03.dto.KHSCalculator;
import section03.dto.KHSCalculator2;
...
//		Calculator calc = new KHSCalculator();
		...
		Calculator calc = new KHSCalculator2();
		...
		System.out.println( calc.div(11111, 33) );
		System.out.println( calc.mod(11111, 33) );
