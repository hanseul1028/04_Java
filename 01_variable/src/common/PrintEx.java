...
public class PrintEx {
	...
	public static void main(String[] args) {
		 ...
		 *  ex) %4d, 3 대입 -> ㅁㅁㅁ3 (ㅁ: 공백)
		 *  
		 *  - 음의 정수 : 정수 크기만큼 칸 확보 + 왼쪽 정렬
		 *  ex) %-4d, 3 대입 -> 3ㅁㅁㅁ
		 *  
		 *  - 소수점 : 소수점 아래 몇번째 자리까지 표시할 지 지정
		 *  					 (지정된 자리 아래에서 반올림 처리)
		 *  ex) %.1f, 3.15 대입 -> 3.2
		 *  */
		...
		// print()확인
		System.out.print("이름 : "); // 줄 바꿈 (개행) x
		System.out.print("홍길동");
		System.out.print(", 나이 : 20세");
		// -> 출력 결과: 이름 : 홍길동, 나이 : 20세
		...
		String name = "신짱구";  // 참조형 (값을 저장x, 값의 위치인 (주소) 저장)
		int age = 5; 						 // 정수 기본형, 4byte
		double height = 80.5; 	 // 실수의 기본형, 8byte
