...
public class ArrayService1 {
	...
	/**
	 * 인원수를 입력받아 그 크기를 가지는 정수 배열을 선언, 할당하고 
	...
	public void method5() {
	  ...
	  // 반복하면서 입력 받기
		...
		/* 최고, 최저점이 기록된 인덱스 찾기 */
		int maxIndex = 0; // 첫 번째 인덱스가 일단 최고/최저 기록
		int minIndex = 0;
		
		// 0번은 비교할 필요 x -> 1번부터 시작
