...
public class ThrowsTest {
	...
	public void method1() throws IOException{
		method2();
		// method2()에서 IOException이 전달돼서 넘어옴
	}
	
	public void method2() throws IOException{
		method3();
		// method3()에서  IOException이 전달돼서 넘어옴
	}
	 ...
	 * 	== 예외 처리 구문 (try-catch, throws)을 쓰지 않아도 되는 예외
	 * - RuntimeException의 자식 예외들이 속함
	 * 
	 * Checked Exception
	...
	// -> 자바라는 언어의 설계 철학(개발자가 손쉽게 사용할 수 있도록 함)
