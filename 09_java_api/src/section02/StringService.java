...
public class StringService {
	 ...
	 * - String은 문자열을 저장하는 필드가 final로 선언되어있음 -> 한 번만 값 대입 가능
	 * 
	 * - 저장된 문자열 수정이 불가하기 때문에 수정을 원할 경우 새로운 String 객체를 
	 * 	생성해서 참조
	 * 
...
//		 int System.identitiyHashCode(Object obj)
		// -> 객체를 구분하는 해시코드 반환
	...
	public void test2() {
		...
		// 같은 값을 지니지만 new 연상자로 String 객체 생성
	 ...
	 * 
	 * - 저장되는 문자열의 길이에 따라서 자동으로 크기가 증가/감소 함
	 * 
	 * - 문자열의 추가/수정/삭제가 발생해도
