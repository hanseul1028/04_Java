...
public class LoopService1 {
	...
	public void displayMenu() {
		...
		System.out.print("실행 할 메서드 번호 입력 >> ");
...
//		}
	  ...
	  // _> 대부분 for문 제어를 위한 변수를 선언
		...
		/**
		 * 두 정수를 입력받아 두 정수 사이 모든 정수를 출력 (무조건 첫번째 입력이 작은 수)
		 * 
		 *  <pre>
		 *  첫 번째 정수 입력 : 5
		 *  두 번째 정수 입력 : 12 
	 ...
	 * <ul>
	 * <li>입력 1 이 입력 2 작거나 같은 경우 : 1234~ 증가하며 출력</li>
	 * <li>입력 1 이 입력 2 보다 큰 경우 	 : 9876~ 감소하며 출력</li>
	 * </ul>
	 */
	public void method4() {
		...
		public void method5() {
			...
			// 방법 2) for 문 초기식, 조건식에 사용될 변수를 미리 정해놓고 대입될 값을 바꾸는 방법
			
			// num1이 작은수 , num2가 큰수 라고 생각하고 변수에 값 대입
			int start = num1;
			int end = num2;
			
			// num1이 큰 수 num2가 작은수 일 때 start, end 대입 값 바꾸기
			if(num1 > num2) {
				start = num2;
				end = num1;
			}
			...
			if(num1 > num2) {
			int temp = num2;	// 임시 변수에 num2 값 저장
			num2 = num1; 			// num2에 num1 값 대입
		...
		/**
		 * 1부터 100 사이 정수 중 입력 받은 정수의 배수가 몇개, 배수의 합 구하기
		 */
		public void method6() {
