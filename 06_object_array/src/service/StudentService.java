...
public class StudentService {
	...
	public StudentService() {
		...
		for (StudentDTO std : students) {
			...
			// random.nextInt(101) : 0이상 101미만의 정수형 난수 생성
	...
	/*
	 * students 객체 배열을 반환하는 메서드 (students에 저장된 주소가 복사돼서 반환됨 == 얕은 복사)
	 * 
	 * @return students
	 */
	...
	/*
	 * <pre> students 객체 배열 요소 중 비어있는(null) 인덱스를 찾아 전달 받은 StudentDTO 객체를 추가 후 true
	 * 반환 단, 비어있는 인덱스가 없으면 false 반환 </pre>
	 * 
	...
	/**
	 * 전달 받은 index가 students 범위 내 인덱스가 맞는지 + 맞다면 index 번째에 참조하는 학생이 있는지 확인하는 메서드
	 * 
	 * @param index
