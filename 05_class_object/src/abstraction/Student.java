...
public class Student {
	...
	public Student() {
		...
		/* 생성자를 이용해서 객체가 생성될 때 필드 값을 원하는 값으로 초기화 할 수 있다*/ 
	...
	/* 오버로딩(OverLoading, 과적)
	 * - 하나의 클래스 내에 같은 이른의 메서드를 여러개 작성하는 기술
	 * - 같은 이름의 메서드는 원래 하나만 존재할 수 있지만
	 * 	 매개변수 (순서, 타입, 개수)를 다르게 하여
	 *	 같은 이름 메서드라도 구분할 수 있게 된다
	 * 
	 */
